	...
	<div class="header" id="home">
		...
		<div class="banner">
			<div class="signing text-right">
				<div class="container">
					<div class="sign-in">
						<a href='<c:url value = "/signin.htm"/>'>Ingresar</a>
					</div>
					<div class="sign-up1">
						<a href='<c:url value = "/signin.htm"/>'>Registrarse</a>
					</div>
					<div class="clearfix"></div>
				</div>
			</div>
			<div class="banner-info text-center">
				<i class="shipping"></i>
				<h3>Lugar exclusivo para compras de Manualidades de Ayacucho</h3>
				<p>Productos especiales de la localidad de Ayacucho hechos a
					mano.</p>
				<a href='<c:url value = "/products.htm"/>'>Todos los Productos</a>
			</div>
		</div>
	</div>
	<div class="content">
